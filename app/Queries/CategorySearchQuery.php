...
final readonly class CategorySearchQuery
{
    /**
     * @param  FilterManager<Category>  $filterManager
     */
    ...
    {
        /** @var CriteriaCollection<Category> $criteria */
        $criteria = new CriteriaCollection();

        /** @var TextSearchCriterion<Category> $textSearch */
