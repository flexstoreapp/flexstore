...
final readonly class AdminInProgressOrderController
{
    public function __invoke(
        ...
        abort_unless($order->fulfillment_status === FulfillmentStatus::Unfulfilled, 409, __('This order is not unfulfilled.'));
