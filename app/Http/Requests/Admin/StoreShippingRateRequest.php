...
final class StoreShippingRateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shipping_carrier_id' => ['required', 'integer', Rule::exists(ShippingCarrier::class, 'id')],
            'name' => ['required', 'string', 'max:255'],
            'type' => ['required', 'string', Rule::enum(ShippingRateType::class)],
            'rate' => ['required_if:type,flat', 'nullable', 'numeric', 'min:0'],
    ...
    public function toDto(): StoreShippingRateInput
    {
        return StoreShippingRateInput::fromArray($this->validated());
    }
