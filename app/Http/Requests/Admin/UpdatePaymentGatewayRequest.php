...
final class UpdatePaymentGatewayRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'driver' => ['sometimes', 'required', Rule::enum(PaymentGatewayDriver::class)],
            ...
            'allowed_regions' => ['sometimes', 'nullable', 'array'],
    ...
    public function toDto(): UpdatePaymentGatewayInput
    {
        return UpdatePaymentGatewayInput::fromArray($this->validated());
    }
