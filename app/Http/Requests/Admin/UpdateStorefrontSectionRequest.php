...
final class UpdateStorefrontSectionRequest extends FormRequest
{
    ...
    {
        return [
            'type' => ['sometimes', 'required', 'string', Rule::enum(StorefrontSectionType::class)],
    ...
    public function toDto(): UpdateStorefrontSectionInput
    {
        return UpdateStorefrontSectionInput::fromArray($this->validated());
    }
}
