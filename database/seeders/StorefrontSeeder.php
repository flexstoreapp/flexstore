        ...
        $menuItems = [
            [
                ...
                'children' => [
                    [
                        'label' => 'New Arrivals',
                        'url' => '/shop?sort=latest',
                        'sort_order' => 1,
                        'children' => [
                            ['label' => 'This Week', 'url' => '/shop?sort=latest', 'sort_order' => 1],
                            ['label' => 'This Month', 'url' => '/shop?sort=latest', 'sort_order' => 2],
                            ['label' => 'Trending Now', 'url' => '/shop?sort=latest', 'sort_order' => 3],
                        ],
                    ],
                    [
                        'label' => 'Best Sellers',
                        ...
                        'sort_order' => 2,
                        'children' => [
                            ['label' => 'Top Rated', 'url' => '/shop?rating=4', 'sort_order' => 1],
                            ['label' => 'Most Reviewed', 'url' => '/shop?rating=4', 'sort_order' => 2],
                            ['label' => 'Customer Favorites', 'url' => '/shop?rating=4', 'sort_order' => 3],
                        ],
                    ],
                    [
                        'label' => 'Electronics',
            ...
            [
                ...
                'children' => [
                    [
                        ...
                        'sort_order' => 1,
                        'children' => [
                            ['label' => 'Up to 30% Off', 'url' => '/shop?on_sale=true', 'sort_order' => 1],
                            ['label' => 'Up to 50% Off', 'url' => '/shop?on_sale=true', 'sort_order' => 2],
                            ['label' => 'Clearance', 'url' => '/shop?on_sale=true', 'sort_order' => 3],
                        ],
                    ],
                    [
                        'label' => 'Men\'s Sale',
                    ...
                    [
                        ...
                        'sort_order' => 3,
                        'children' => [
                            ['label' => 'Today\'s Deals', 'url' => '/flash-sales', 'sort_order' => 1],
                            ['label' => 'Weekly Specials', 'url' => '/flash-sales', 'sort_order' => 2],
                            ['label' => 'Last Chance', 'url' => '/shop?on_sale=true', 'sort_order' => 3],
                        ],
                    ],
                ],
            ],
        ...
        $menuItems = [
            [
                ...
                'children' => [
                    ...
                    ['label' => 'Sale', 'url' => '/shop?on_sale=true', 'sort_order' => 5],
                ],
            ],
            [
                'label' => 'Company',
