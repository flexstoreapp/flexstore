...
import { MercadoPagoCredentialsForm } from './mercadopago-credentials';
import { MercadoPagoWebhookTab } from './mercadopago-webhook-tab';
...
const tabFields: Record<PaymentGatewayDialogTab, string[]> = {
    general: ['name', 'credentials.public_key', 'credentials.access_token', 'credentials.checkout_mode', 'is_active'],
    conditions: [
        'min_order_value',
        'max_order_value',
        'min_weight',
...
const webhookTab: AdditionalTab = {
    ...
    content: (props) => <MercadoPagoWebhookTab {...props} />,
};
...
export function MercadoPago({ paymentGateway, onToggle }: MercadoPagoProps) {
        ...
        <Card className="group/item h-38 shadow-xs md:h-45">
            <CardContent className="flex h-full flex-col">
                <div className="flex flex-1 items-center justify-center">
                    <MercadoPagoLogo className="h-10" />
                </div>
                ...
                <div className="flex items-center justify-between">
                    ...
                    <PaymentGatewayDialog
                        ...
                        title="Mercado Pago"
                        description={__('Configure Mercado Pago payment gateway')}
                        paymentGateway={paymentGateway}
                        gatewayDriver="mercadopago"
                        tabFields={tabFields}
                        credentialFields={(props) => <MercadoPagoCredentialsForm {...props} />}
