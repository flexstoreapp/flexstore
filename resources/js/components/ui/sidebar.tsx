    ...
    return (
        <ScrollArea
            ...
            className={cn(
                ...
                // Radix sizes the viewport's content box with display:table, which
                // grows to max-content — a long menu label would then push every
                // end-aligned item out of view. Block keeps it at the sidebar width.
